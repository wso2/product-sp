1. Copy {WSO2SPHome}/samples/artifacts/0001/kafka-sample.siddhi file to {WSO2SPHome}/deployment/siddhi-files
...
3. Add the kafka libs to {WSO2SPHome}/samples/artifacts/sample-clients/lib
