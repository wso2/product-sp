...
echo "testing Logistic Regression LBFGS workflow"
...
project=$(curl -H "Content-Type: application/json" -H "Authorization: Basic YWRtaW46YWRtaW4=" -v https://$SEVER_IP:$SERVER_PORT/api/projects/wso2-ml-logistic-regression-lbfgs-tuned-sample -k)
sleep 2
...
analysis=$(curl -H "Content-Type: application/json" -H "Authorization: Basic YWRtaW46YWRtaW4=" -v https://$SEVER_IP:$SERVER_PORT/api/projects/${projectId}/analyses/wso2-ml-logistic-regression-lbfgs-tuned-analysis -k)
sleep 2
...
curl -X POST -d @'hyper-parameters' -H "Content-Type: application/json" -H "Authorization: Basic YWRtaW46YWRtaW4=" -v https://$SEVER_IP:$SERVER_PORT/api/analyses/${analysisId}/hyperParams?algorithmName=LOGISTIC_REGRESSION_LBFGS -k -v
sleep 2
