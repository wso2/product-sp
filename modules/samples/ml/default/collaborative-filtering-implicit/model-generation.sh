...
echo "testing Collaborative filtering implicit workflow"
...
project=$(curl -H "Content-Type: application/json" -H "Authorization: Basic YWRtaW46YWRtaW4=" -v https://$SEVER_IP:$SERVER_PORT/api/projects/wso2-ml-collaborative-filtering-implicit-sample-project -k)
sleep 2
...
analysis=$(curl -H "Content-Type: application/json" -H "Authorization: Basic YWRtaW46YWRtaW4=" -v https://$SEVER_IP:$SERVER_PORT/api/projects/${projectId}/analyses/wso2-ml-collaborative-filtering-implicit-sample-analysis -k)
sleep 2
...
for i in `seq $modelCount`; do
	...
	curl -H "Content-Type: application/json" -H "Authorization: Basic YWRtaW46YWRtaW4=" -k -v "https://$SEVER_IP:$SERVER_PORT/api/models/${modelId}/product-recommendations?user-id=1&no-of-products=3"
	sleep 5

	echo "#recommend users"
	curl -H "Content-Type: application/json" -H "Authorization: Basic YWRtaW46YWRtaW4=" -k -v "https://$SEVER_IP:$SERVER_PORT/api/models/${modelId}/user-recommendations?product-id=123&no-of-users=2"
	sleep 5
done
