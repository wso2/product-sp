...
<div id="wrap">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul class="breadcrumb pull-left">
                            ...
                            <li class="active">ESB Mediation Statistics - Proxy</li>
                        </ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1>ESB Mediation Statistics - Proxy</h1>
                ...
                <div class="container content-section">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <iframe id="dashboardWidget-2" src="gadgets/simple.bar.chart.jag?t=Now&rtype=Proxy"
                                    class="single-column-gadget"></iframe>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <iframe id="dashboardWidget-3" src="gadgets/gauge_InDirection.jag?t=Now&rtype=Proxy"
                                    class="gadget-small"></iframe>
                        </div>
                        <!--/span-->
                        <div class="col-lg-6">
                            <iframe id="dashboardWidget-4" src="gadgets/gauge_OutDirection.jag?t=Now&rtype=Proxy"
