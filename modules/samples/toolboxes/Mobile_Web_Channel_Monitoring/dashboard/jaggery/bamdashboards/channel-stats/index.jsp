...
<head>
    ...
    <title>Mobile/Web Channel Monitoring</title>
...
<div id="wrap">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul class="breadcrumb pull-left">
                            ...
                            <li class="active">Mobile/Web Channel Monitoring</li>
                        </ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1>Mobile/Web Channel Monitoring</h1>
    ...
    <script type="text/javascript">
        var currentTab = "Mobile/Web Channel Monitoring";
    </script>
