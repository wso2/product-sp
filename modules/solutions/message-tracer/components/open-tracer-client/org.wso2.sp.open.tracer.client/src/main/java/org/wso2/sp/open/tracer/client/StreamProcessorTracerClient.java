...
public class StreamProcessorTracerClient {
    ...
    public Tracer getTracer(String serviceName) throws AnalyticsTracerInitializationException {
        ...
        Tracer tracer = AnalyticsTracerLoader.getInstance().getTracer(tracerConfig);
        return tracer;
    }
