...
public class PropertyBasedGenerator {
    ...
    public static Object generatePropertyBasedData(PropertyBasedAttributeDto propertyBasedAttributeDto) {
        ...
        switch (categoryType) {
            ...
            case RandomDataGeneratorConstants.MODULE_CALENDAR:
                ...
                switch (propertyType) {
                    ...
                    case RandomDataGeneratorConstants.MODULE_CALENDAR_DATE:
                        ...
                        dataValue = calendar.relativeDate(DateTime.now().plusDays(incrementValue)).asString(DateFormat.dd_MM_yyyy_H_m_s_a);
                        break;
                    default:
                        log.error("Category '" + categoryType + "' does not contain property '" + propertyType + "'.");
                        throw new EventSimulationException("Category '" + categoryType + "' does not contain property '" + propertyType + "'.");
                }
                break;
            ...
            default:
                log.error("Invalid category : '" + categoryType + "'.");
                throw new EventSimulationException("Invalid category : '" + categoryType + "'.");
